...
@SpringBootTest(classes = {AWTTestConfiguration.class, EagerConfiguration.class, MainConfiguration.class,
        ...
        ControllerServer.class, JsonClientConnection.class, ObjectStreamClientConnection.class, ActionProcessor.class, TimeoutWatcher.class, ObjectStreamClient.class})
